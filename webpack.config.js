...
module.exports =  ({production, server, extractCss, coverage} = {}) => ({
        ...
        plugins: [
			...
			baseUrl: baseUrl
                  ...
                  new CopyWebpackPlugin([ { from: 'img', to: 'img' },{ from: 'js', to: 'js' },{ from: 'styles', to: 'styles' }/*,{ from: 'node_modules/please-wait', to: 'node_modules/please-wait' },{ from: 'node_modules/spinkit', to: 'node_modules/spinkit' }*/
      		    ]),
